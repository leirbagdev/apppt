      ...
      <div className="min-h-screen bg-black text-white overflow-hidden">
        ...
        <section className="pt-40 pb-28 px-4 sm:px-8 md:px-16 relative mb-20 md:mb-32">
          <div className="max-w-7xl mx-auto text-center" style={{ transform: `translateY(${parallaxOffset}px)` }}>
            <FadeIn duration={800}>
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-green-100 to-green-300 bg-clip-text text-transparent leading-tight md:leading-[1.15] text-left">
                Gerencie seus alunos e impulsione resultados como
                <br />
                <span className="text-green-400 animate-pulse">Personal Trainer</span>
              </h1>
            </FadeIn>
