                        ...
                        {workout.assignedTo && workout.assignedTo.length > 0 ? (
                          ...
                          <div className="text-center py-6">
                            ...
                            <p className="text-muted-foreground mb-4">
                              Este treino ainda não foi atribuído a nenhum aluno
                            </p>
                            <Button
                              variant="outlined"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span>{Array.from(new Set(workout.exercises.map((e) => e.muscle))).join(", ")}</span>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-muted-foreground">Equipamentos Necessários:</span>
                            <span>{Array.from(new Set(workout.exercises.map((e) => e.equipment))).join(", ")}</span>
                          </div>
                        </div>
                        <div className="space-y-2">
                          <div className="flex justify-between">
                        ...
                        >
                          <div className="flex justify-between items-start">
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-sm text-muted-foreground">Descanso: {exercise.rest}</div>
                            </div>
                          </div>
                        </Card>
                      ))}
                ...
                <TabsContent value="settings" className="mt-0">
                  ...
                  >
                    <div className="text-center py-12">
                      ...
                      <p className="text-muted-foreground">Configurações do treino em desenvolvimento</p>
                    </div>
                  </motion.div>
                </TabsContent>
              </div>
          ...
          <Card className="p-4">
            ...
            <div className="flex flex-wrap gap-2">
              {workout.tags.map((tag, index) => (
                <Chip key={index} variant="assist" size="sm">
                  {tag}
                </Chip>
              ))}
            </div>
